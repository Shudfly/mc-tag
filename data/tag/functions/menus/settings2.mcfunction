...
tellraw @s ["",{"translate":"< PREV","color":"yellow","underlined":true,"clickEvent":{"action":"run_command","value":"/function tag:menus/settings1"}},"  ",{"translate":"Page 2/3","color":"green","underlined":false},"  ",{"translate":"NEXT >","color":"dark_gray","underlined":false}]
tellraw @s {"text":"----------","color":"dark_gray","bold":true,"strikethrough":true}
tellraw @s " "